...
export default function ShopContent() {
  ...
  return (
    <>
      ...
      {/* Tabs */}
      <div data-cur="cursor" className="max-w-7xl mx-auto w-full px-4 flex gap-2 mb-6">
        {filterTabs.map((tab) => (
          <button
            key={tab.value}
            className={`px-4 py-1 rounded-full border text-sm font-medium transition-colors ${activeTab === tab.value
