...
export default function CuratedExperiences({
  ...
  return (
    <div className="relative bg-gradient-to-r from-[#290101]  to-[#8B0000] overflow-hidden h-screen ">
      {/* Background Image */}
      <div className="absolute bottom-0  transition-all ease-in-out duration-500 right-0 text-white w-[30vh] h-[30vh] md:w-[70vh] md:h-[70vh] lg:w-[90vh] lg:h-[90vh] z-0">
        <Image
      ...
      <div className="flex z-50 items-center h-full p-5 md:p-8 lg:p-12 md:text-left text-center">
        <div className="flex flex-col gap-5 md:gap-8 ">
          <h2 className="text-xl z-50 md:text-2xl text-[#E9B873] font-semibold md:text-3xl font-serif">
            OVER 200 CURATED FRAGRANCES.
            <br />
            ONE SIGNATURE EXPERIENCE.
          </h2>
          <p className="text-neutral-200 z-50 max-w-2xl md:text-xl mx-auto">
