...
const HoverAddToCartButton: React.FC<HoverAddToCartButtonProps> = ({ product, className = '' }) => {
  ...
  return (
    <button 
      ...
      className={`w-full bg-[#a00000] hover:bg-[#b30000] text-white py-2 rounded-lg transition-colors ${isLoading || isAdding ? 'opacity-75 cursor-not-allowed' : ''} ${className}`}
    >
