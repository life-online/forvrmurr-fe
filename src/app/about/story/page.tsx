...
export default function Obsession() {
  return (
    <div className="bg-black text-white min-h-screen w-full text-center">
      <Navbar />
      {/* Hero Section */}
      <section className="relative h-screen py-5 w-full flex items-center justify-center bg-gradient-to-r from-[#320000] to-black  text-white py-20  px-4">
      ...
      <section className="flex justify-center">
        <div className="bg-black max-w-6xl mt-16  text-center md:text-left grid md:grid-cols-2 gap-10 items-center">
          <div>
            <img
              src="/locations.svg"
              alt="Perfume Bottle"
