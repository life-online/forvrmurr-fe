      ...
      >
        {!isSubmitted ? (
          <div className="flex flex-col md:flex-row gap-10 mb-16">
            <div className="w-full md:w-2/3 bg-white rounded-lg p-8 shadow-sm">
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm border-l-4 border-[#8b0000] max-w-2xl mx-auto text-center">
