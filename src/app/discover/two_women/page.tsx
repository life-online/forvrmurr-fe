    ...
    return (
      <div className="bg-black text-white min-h-screen">
        ...
        <section className="bg-white text-black pt-3 pb-20 px-6 text-center">
          <h3 className="text-red-700 uppercase text-sm tracking-widest mb-2">Meet the Team</h3>
          ...
          <div className="grid md:grid-cols-2 gap-5 max-w-3xl mx-auto">
            <div className=" p-6 rounded-lg">
              ...
              <p className="text-sm">
                Ayodeji is known for her friend-first work for Forvr. Her communication ethos shapes Murr’s every move. Passionate about art and perfume as a method of archiving, she pulls references from a catalog of cinema, opera, and oral tradition.
                A trained writer, Ayodeji has told scent stories for Google, Armani, and more. She self-published a tiny perfume glossary with the fictional Queen of the Night by The Merchant of Venice.
              </p>
            </div>
