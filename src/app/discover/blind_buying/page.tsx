  ...
  return (
    <div className="w-full text-center">
      ...
      <div className="absolute inset-0">
        ...
        <div className="relative z-10 max-w-3xl h-[75%] bg-center bg-cover bg-no-repeat p-8 rounded-xl flex flex-col items-center justify-center" style={{ backgroundImage: "url('/centered-bg.svg')" }}>
          ...
          <p className="text-[#F8D49A] text-[24px] mb-6 text-center">
            Whether it&apos;s a signature scent or a fleeting flirt, you deserve options —
            without the pressure of a $300 commitment.
          </p>
